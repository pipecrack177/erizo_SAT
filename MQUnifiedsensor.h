...
{
  public:
    MQUnifiedsensor(String Placa = "Arduino", float Voltage_Resolution =  5, float Sensor_Voltage = 5,  float Divider_Factor = 1, int ADC_Bit_Resolution = 10, int pin = 1, String type = "CUSTOM MQ");
    ...
    void setSensorVoltage(float sensor_voltage = 5.0);
    void setDividerFactor(float divider_factor = 1.0);
  ...
  private:
    ...
    float _SENSOR_VOLTAGE = 5.0;
    float _DIVIDER_FACTOR = 1.0;
